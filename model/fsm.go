...
type ExtData struct {
	...
	TransactionTime int64   `gorm:"column:transaction_time;type:bigint(20);not null;default:0;comment:'业务时间'"` // 业务时间
	Comment         string  `gorm:"column:comment;type:varchar(128);not null;default:'';comment:'备注说明'"`       // 备注说明
}

// TableName get sql table name.获取数据库表名
func (m *ExtData) TableName() string {
	return "ext_data"
}
